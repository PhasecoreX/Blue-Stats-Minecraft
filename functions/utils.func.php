...
function fuzzyDate($date, $inputFormat = DateTime::ATOM, $outputDateFormat = "l, F jS, Y", $outputTimeFormat = "g:ia")
{
	...
	// Fuzzy Date ranges
	$lastWeekStart = new DateTime("2 weeks ago sunday midnight", $timezone);
	$thisWeekStart = new DateTime("1 week ago sunday midnight", $timezone);
	...
	$twoDaysStart = new DateTime("2 days midnight", $timezone);
	$nextWeekStart = new DateTime("sunday midnight", $timezone);
	$twoWeekStart = new DateTime("1 week sunday midnight", $timezone);
	...
	if ($dateTime < $lastWeekStart) {
		...
		// Yesterday
		$fuzzyDate = "Yesterday";
	} elseif ($dateTime < $tomorrowStart) {
		// Today
		$fuzzyDate = "Today";
	} elseif ($dateTime < $twoDaysStart) {
		// Tomorrow
		$fuzzyDate = "Tomorrow";
	} elseif ($dateTime < $nextWeekStart) {
		// Sometime in the current week
		$prefix = "This";
		$fuzzyDate = ucwords($dateTime->format("l"));
	} elseif ($dateTime < $twoWeekStart) {
